...
__code USB_CFG_DESCR_HID CfgDescr = {
  ...
  .interface0 = {
    ...
    .bInterfaceSubClass = 0,                      // pas d'interface boot : sinon macOS le classe clavier
...
__code uint8_t ReportDescr[] ={
    // En premier : macOS classe l'appareil d'après la première collection, et refuse
    // qu'une application écrive vers un appareil classé « clavier ».
    // Canal de réglage en direct (MacroPad RGB)
    ...
    0x09, 0x01,                    //   USAGE (1)
    0x81, 0x02,                    //   INPUT (Data,Var,Abs) : événements pour l'appli
    0xc0,                          // END_COLLECTION
